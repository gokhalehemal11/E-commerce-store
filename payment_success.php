...
echo "<script>console.log('$trx_id');</script>";
echo "<script>console.log('$p_st');</script>";
echo "<script>console.log('$amt');</script>";
echo "<script>console.log('$cc');</script>";
echo "<script>console.log('$cm_user_id');</script>";
echo "<script>console.log('$c_amt');</script>";
